...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { return "请输入至少 " + (min - input.length) + " 个字"; },
        formatSelectionTooBig: function (limit) { return "您只能选择 " + limit + " 项" + (limit == 1 ? "" : ""); },
        formatLoadMore: function (pageNumber) { return "正在加载更多数据..."; },
        formatSearching: function () { return "正在搜索中..."; },
